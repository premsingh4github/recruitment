...
<div id="page-wrapper">  
    <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Resume>>Approved</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
    <div class="row">
                            ...
                            <div class="panel-body">
                                <div class="dataTable_wrapper">
                                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        ...
                                        <td width='20%'>Employee Name:</td><td>{{$det->fname}} {{$det->lname}}</td>
                                        </tr>
                                        <tr>                                     
                                        
                                        <tr>
                                        <td width='20%'>Employee Address:</td><td>{{$det->raddress1}} {{$det->country}} {{$det->mobile}}</td>
                                        </tr>
                                        <tr>
                                        <td width='20%'>Agent Name:</td><td>{{$ag->name}}</td>
                                        </tr>
                                        <tr>
                                        <td width='20%'>Agent Address:</td><td>{{$ag->address}},Mobile:{{$ag->contactNumber}}</td>
                                        </tr>
                                        <tr>
                                        <td width='20%'>Employer Name:</td><td>{{$em->name}}</td>
                                        </tr>
                                        <tr>
                                        <td width='20%'>Employer Address:</td><td>{{$em->address}},Mobile:{{$em->contactNumber}}</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td width='20%'>
                                                <a href="{{url()}}/resume"><button type="button" class="btn-xs btn-primary">Back</button></a>
