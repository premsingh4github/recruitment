                                ...
                                <div class="dataTable_wrapper">
                                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        <ul class="dashboardItems">
                                            <li class="curveSmall"> <a href="{{url()}}/agent/{{Auth::user()->id}}"> <img src="{{url()}}/images/profile.gif" />
                                            <p>Profile</p>
                                                </a> </li>
                                            ...
                                            <li class="curveSmall"> <a href="{{url()}}/demand_view"> <img src="{{url()}}/images/demand.gif" />
                                            <p>VIew Demand</p>
                                                </a> </li>
