                                ...
                                <div class="dataTable_wrapper">
                                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        <ul class="dashboardItems">
                                            <li class="curveSmall"> <a href="{{url()}}/country"> <img src="{{url()}}/images/setting.gif" />
                                            <p>Country Setting</p>
                                                </a> </li>
                                            <li class="curveSmall"> <a href="{{url()}}/identification"> <img src="{{url()}}/images/setting.gif" />
                                            <p>Identification Setting</p>
                                                </a> </li>
                                                <li class="curveSmall"> <a href="{{url()}}/qualification"> <img src="{{url()}}/images/setting.gif" />
                                            <p>Education Setting</p>
                                                </a> </li>
                                                <li class="curveSmall"> <a href="{{url()}}/fieldofstudy"> <img src="{{url()}}/images/setting.gif" />
                                            <p>Field of Study Setting</p>
                                                </a> </li>
                                                <li class="curveSmall"> <a href="{{url()}}/industry"> <img src="{{url()}}/images/setting.gif" />
                                            <p>Work Sector Setting</p>
                                                </a> </li>
                                                <li class="curveSmall"> <a href="{{url()}}/position"> <img src="{{url()}}/images/setting.gif" />
                                            <p>Job Title Setting</p>
                                                </a> </li>
                                                <li class="curveSmall"> <a href="{{url()}}/currency"> <img src="{{url()}}/images/setting.gif" />
